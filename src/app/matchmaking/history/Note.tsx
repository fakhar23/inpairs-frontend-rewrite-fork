...
const Note = ({ matchToEdit = {}, setMatchToEdit }: any) => {
  const { mutateAsync: updateMatchmaking, ...resUpdateMatchmaking } = useUpdateMatchmaking()
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="text-2xl text-purple-900 mr-7 mt-2">
        {matchmaker_notes ? "Edit" : "Add"} Notes Mesagge for <UserLink user={UserOne} /> &{" "}
        <UserLink user={UserTwo} />
      </div>
      <textarea
        ref={textareaRef}
