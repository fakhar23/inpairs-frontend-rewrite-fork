      ...
      <div className="relative w-full flex rounded-md justify-center items-center">
        <input
          ...
          className={`border-transparent h-12 outline-0 peer px-4 placeholder-transparent rounded-lg
           text-inputNeutralDark w-full transition-all duration-300 ${
             label ? "pt-4" : ""
           } ${inputClassName}
            focus:placeholder-inputMediumSlate`}
          {...props}
        />
        <label
          htmlFor={id}
          className={`absolute bg-transparent duration-300 origin-[0] px-2 scale-75 text-inputNeutralMedium top-4 left-0 transform -translate-y-4 z-4 
