  ...
  return (
    <label>
      <div className="w-full my-5 h-[12rem]">
        <div className="h-full w-full z-1 bg-slate-400 flex flex-col gap-5 items-center justify-center cursor-pointer bg-opacity-[0.2] rounded-xl">
          <UploadIcon />
          <p className="text-slate-600">upload your photos</p>
        </div>
