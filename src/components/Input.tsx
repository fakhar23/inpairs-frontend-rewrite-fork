    ...
    <div className={twMerge("w-full mb-2 relative", className)}>
      ...
      <input
        ...
        className={twMerge(
          ...
          variation === "secondary" &&
            "bg-gray-50 rounded-[10px] px-3 border-gray-200 mt-2 leading-tight h-[3rem] w-full md:h-[4rem] text-gray-gunmetal outline-none focus:outline-primary",
          rest.readOnly &&
    ...
    <div className={twMerge("w-full mb-2 relative", className)}>
      ...
      <textarea
        ...
        className={twMerge(
          ...
          variation === "secondary" &&
            "bg-gray-50 rounded-[10px] px-3 border-gray-400 mt-2 leading-tight w-full     text-gray outline-none focus:outline-primary",
          rest.readOnly &&
            "bg-gray-100 text-gray-gunmetal cursor-not-allowed focus:outline-gray focus:outline"
        )}
        {...rest}
